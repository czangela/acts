...
#include "Acts/Seeding2/SeedfinderConfig.hpp"
...
class Seedfinder {
 ...
 public:
  ...
  Seedfinder(Acts::detail::SeedfinderConfig<external_spacepoint_t> config);
  ~Seedfinder() = default;
 ...
 private:
  ...
  Acts::detail::SeedfinderConfig<external_spacepoint_t> m_config;
};

}  // namespace Acts

#include "Acts/Seeding2/Seedfinder.ipp"
